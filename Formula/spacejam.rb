class Spacejam < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/spacejamapp/homebrew-spacejam/releases/download/v0.0.1/spacejam-0.6.7-macos-arm64.tar.gz"
    sha256 "c4a5d30b49b3d8457b43668a6a3b3104f43a8bdcb81dfb1e56af9b21f810cecf"
  else
    url "https://github.com/spacejamapp/homebrew-spacejam/releases/download/v0.0.1/spacejam-0.6.7-macos-amd64.tar.gz"
